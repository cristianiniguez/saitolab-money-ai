        ...
        {step === 'upload' && (
          <div className="space-y-4 mt-2">
            <p className="text-sm text-muted-foreground">
              ...
              The <code className="font-mono text-xs bg-muted px-1 py-0.5 rounded">slug</code> column is optional — it will be auto-generated from the name if blank.
            </p>
            <button
              type="button"
        ...
        {step === 'done' && (
          <div className="mt-2 flex flex-col items-center gap-3 py-6 text-center">
            ...
            <p className="font-medium text-foreground">
              {importResult?.imported} categor{importResult?.imported !== 1 ? 'ies' : 'y'} imported successfully
            </p>
            {importResult?.errors && importResult.errors.length > 0 && (
              <p className="text-sm text-muted-foreground">
